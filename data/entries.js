window.INTERNSHIP_ENTRIES = [
  ...
  },
  {
    ...
    date: "模板",
    type: "技术笔记",
    title: "技术学习模板：从会用到会解释",
    summary: "每学一个技术点，都记录它解决什么问题、核心原理、常见坑、调试方法和面试追问。",
    tags: ["技术沉淀", "学习方法", "面试追问"],
    project: "学习体系",
    result: "建立技术卡片写法"
  },
  {
    ...
    date: "模板",
    type: "项目复盘",
    title: "项目复盘模板：目标、架构、难点、验证",
    summary: "把项目经历整理成目标、模块、难点、方案、数据、复盘六段式，方便之后写简历和准备技术面。",
    tags: ["项目复盘", "STAR", "简历素材"],
    project: "复盘体系",
    result: "沉淀项目表达框架"
  },
  {
    ...
    date: "模板",
    type: "学习心得",
    title: "每天记录 3 个证据：问题、行动、结果",
    summary: "不要只写今天很忙，而要写清楚遇到什么问题、采取了什么行动、产生了什么可验证结果。",
    tags: ["学习心得", "证据意识", "复盘"],
    project: "个人成长",
    result: "提升记录质量"
  },
  {
    ...
    date: "模板",
    type: "面试素材",
    title: "一次调试经历如何讲成 STAR 故事",
    summary: "把调试经历拆成场景、任务、行动、结果，并补充排查链路和量化指标。",
    tags: ["STAR", "调试", "技术面试"],
    project: "面试准备",
    result: "形成可复用回答"
  }
